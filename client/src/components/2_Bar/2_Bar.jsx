...
export default function $2_Bar({ setCurrentStep, currentStep, myUser, setMyUser }) {
  ...
  function changeBackground() {
    ...
    } else if (storyPath === "orderDrink" && storyChoice === 0) {
      setBackgroundImageClass("background background_bartenderdrink");
    } else if (storyPath === "askPirates" && storyChoice === 0) {
      setBackgroundImageClass("background background_bartender");
    } else if (storyPath === "bartenderNumber" && storyChoice === 0) {
      setBackgroundImageClass("background background_bartenderangry");
    }
  }
